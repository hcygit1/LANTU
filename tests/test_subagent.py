...
from lantu.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from lantu.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from lantu.agents.trace import TraceManager, TraceNode
from lantu.agents.task_manager import BackgroundTask, TaskManager
from lantu.agents.notification import format_task_notification, inject_task_notifications
from lantu.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".lantu" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from lantu.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from lantu.tools.agent_tool import AgentToolParams
