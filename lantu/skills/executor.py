...
from lantu.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from lantu.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from lantu.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
