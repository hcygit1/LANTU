...
def build_teammate_tools(
    ...
    from lantu.tools.send_message import SendMessageTool
    from lantu.tools.task_create import TaskCreateTool
    from lantu.tools.task_get import TaskGetTool
    from lantu.tools.task_list import TaskListTool
    from lantu.tools.task_update import TaskUpdateTool
