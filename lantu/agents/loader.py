...
PROJECT_AGENTS_DIR = ".lantu/agents"
USER_AGENTS_DIR = "~/.lantu/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("lantu.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from lantu.agents.parser import parse_frontmatter, _validate_agent_meta
