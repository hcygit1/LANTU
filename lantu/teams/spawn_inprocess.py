...
from lantu.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from lantu.agent import Agent
    from lantu.conversation import ConversationManager
    from lantu.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from lantu.conversation import ConversationManager as CM
                conv = CM()
